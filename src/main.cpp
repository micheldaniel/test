...
{
    int64 nSubsidy = 0;
    if (nHeight == 1) nSubsidy = 1000000000000 * COIN; // IPO block
    else
    if (nHeight <= 20000) nSubsidy =  10000 * COIN;
    else
    if (nHeight <= 30000) nSubsidy = 5000 * COIN;
    else
    if (nHeight <= 40000) nSubsidy = 2500 * COIN;
    else
    if (nHeight <= 50000) nSubsidy = 1000 * COIN;
    else
    if (nHeight <= 60000) nSubsidy = 500 * COIN;
    else
    if (nHeight <= 70000) nSubsidy = 250 * COIN;
    else
    if (nHeight <= 80000) nSubsidy = 100 * COIN;
    else
    if (nHeight <= 90000) nSubsidy = 50 * COIN;
    else nSubsidy = 25 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespanDigi = 30; // 9 minutes (NUM_ALGOS * 45 seconds)
static const int64 nTargetSpacingDigi = 30; // 9 minutes (NUM_ALGOS * 45 seconds)
